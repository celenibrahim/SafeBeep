    ...
    return(
        <ScrollView style={styles.container}>
            <View>
                ...
                <View>
                    <Input label='Usercode' placetext='Enter your usercode...' onChangeText={setUser} value={Usercode}/>
                    <Input label='Password' placetext='Enter your password...' onChangeText={setPassword} value={Password}/>
                </View>
                <View>
